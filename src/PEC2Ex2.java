 /**
    ...
    public class PEC2Ex2
    {
         ...
         */
        //Default constuctor
        public PEC2Ex2() throws Exception
        {
         ...
         */
        //Args constructor 1
        public PEC2Ex2(String name, String street, double latitude, double longitude, int capacity) throws Exception
        {
            setName(name);
            setStreet(street);
